      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 hover:opacity-95 transition-opacity group">
            <div className="flex items-center justify-center bg-white rounded-xl shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all overflow-hidden" style={{ width: '60px', height: '60px' }}>
              <img
                src="/images/rosario-investment-club.jpg"
            ...
            <div className="flex flex-col justify-center">
              <h1 className="text-xl font-black tracking-tight text-white">ROSARIO</h1>
              <p className="text-xs text-purple-100 -mt-0.5 font-semibold">Investment Club</p>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center justify-center bg-white rounded-lg shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all overflow-hidden pl-4" style={{ width: '45px', height: '45px' }}>
              <img
